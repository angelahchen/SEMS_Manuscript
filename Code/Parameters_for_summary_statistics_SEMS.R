...
############# Parameters for the setting ###################
  ...
  summary.dir = "/Summary_Statistics/Setting_1/SEMS/"; # where the summary statistics tables go
  simulation.results.dir = "/Analysis/SEMS/"; # where the analysis results file is  
  file.name.prefix= "Setting_1_SEMS" # file name of the analysis results
